...
\author{\textbf{Marian Kucała}\\Korekta OCR [niedokończona], skład i
  transliteracja [prowizoryczna] alfabetu Parkosza:\\ Janusz S. Bień}

\title{PRZEKŁAD POLSKI\\Traktat o ortografii polskiej [Jakuba Parkosza]}

{\relsize{-2}
\date{\textbf{Licencje}:\\ \relsize{-2}Creative Commons [Wspólnota twórcza]\\
Uznanie autorstwa --- Na tych samych warunkach --- Polska\\
wersja 2.5 lub późniejsza\\\textit{także}\\
GNU Free Documentation License\\
{\today (wersja 18 maja 2015)}}
}
