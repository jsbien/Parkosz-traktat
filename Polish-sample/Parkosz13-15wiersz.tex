...
\newverseline \hypht{bar}{zo} gru6eÿe.

\indentVerse Thako piſſmem \textit{czas} \hyphh{ʋiſɲa}{ÿe}

\includegraphics[width=\hsize]{wierszP18}

\newverseline \hypht{ʋiſɲa}{ÿe} Gdy \add{h} przÿpiſſano bødze/
...
\indentVerse Piſch gee \hyphh{Vgÿ}{mo}

\includegraphics[width=\hsize]{wierszP24}

\splitverse

\hypht{Vgÿ}{mo} boſze thako/
...
% \includegraphics[width=0.2\hsize]{Pilas/a}
% \includegraphics[width=0.2\hsize]{Pilas/aa}
% \includegraphics[width=0.2\hsize]{Pilas/b}
% \includegraphics[width=0.2\hsize]{Pilas/b2}
% \includegraphics[width=0.2\hsize]{Pilas/b3}
% \includegraphics[width=0.2\hsize]{Pilas/b4}
