...
\parkosz{Adaaṁ} \parkosz{biḷ} \parkosz{bĳḷ} \parkosz{caḷ} \parkosz{kaal} \parkosz{czas} \parkosz{çaḷo} \parkosz{chood}

\parkosz{daaḷ} \parkosz{dzaaḷ} \parkosz{eſz} \parkosz{ﬀitaa} \parkosz{fiꝿi} \parkosz{i} \parkosz{ġee} \parkosz{ĳe} /\parkosz{ꝿhaaɲ}
...
\parkosz{ʋiɬaaḷ} \parkosz{wſta} \parkosz{xøøodz} \parkosz{ĳąṅczøc} \parkosz{ĳoczi}
...
\parkosz{Kaḷſdey} \parkosz{ꝿodzĳṅĳ} \parkosz{varzylcowſjkĳ}¹. 
