...
\firstsubline{\parkosz{Adaaṃ} \parkosz{biḷ} \parkosz{bijḷ} \parkosz{caḷ} \parkosz{kaal}}

\nextsubline{\parkosz{czas} \parkosz{çaḷo} \parkosz{chood}}

\parkosz{daaḷ} \parkosz{dzaaḷ} \parkosz{eſz} \parkosz{ffitaa} \parkosz{fiꝿi} \parkosz{i} \parkosz{ġee} \parkosz{ije} /\parkosz{ꝿhaaɲ}

\parkosz{kroɬ} \parkosz{ḷis} \parkosz{ɬis} \parkosz{ɱikaa} \parkosz{ṃika} \parkosz{ɲiſſki} \parkosz{ṇiſki}

\parkosz{othooſz} \parkosz{ƥiġe} \parkosz{piſchṇo} \parkosz{qʋras} \parkosz{roſſa} \parkosz{rzøøſſa}
...
\parkosz{\hypht{zza}{raa}} \parkosz{Zaɱɲø} \parkosz{to} \parkosz{uṃee} \parkosz{uuɲ}¹ \parkosz{viḷa}
% 88	uuq niejasne> w oryginale mogło być uuy, tj. uj 'wuj\

\parkosz{ʋiɬaaḷ} \parkosz{wſta} \parkosz{xøøodz} \parkosz{ijąṇczøc} \parkosz{ijoczi}
...
\parkosz{Kaḷſdey} \parkosz{ꝿodzijṇij} \parkosz{varzylcowſjkij}¹.
