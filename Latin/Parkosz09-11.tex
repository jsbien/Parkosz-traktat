...
%\url{http://ebuw.uw.edu.pl/Content/215606/directory.djvu?djvuopts=&page=51&zoom=width&showposition=0.5,0.18}
  \url{https://jsbien.github.io/Parkosz4IIIF/\#?cv=8&manifest=https://jsbien.github.io/Parkosz4IIIF/collection/ParkoszJBC/index.json}
...
\indentK \parkosz{D} eciam duas habet voces, sed facile differentes, scilicet \parkosz{d} simplex

% znak nieczytelny, l' w dal' może pod wpływem Łosia?
seu spissum et \parkosz{dz} molle. Exemplum primi: \parkosz{daɬ} \parkosz{deeɲko} \parkosz{diɱ}

% znak nieczytelny, dlaczego oddany jako n'? Do wyjaśnienia.
\parkosz{dooɱ} \parkosz{duɱaa} \parkosz{doøb}. Exemplum secundi: \parkosz{dzaḷ} \parkosz{dzen'} \parkosz{dziv} \parkosz{\hyphh{dzoḷ}{da}}

\parkosz{\hypht{dzoḷ}{da}} \parkosz{dzuḷa} \parkosz{dzøøġiɬ} \parkosz{dzøøſḷa}. Itaque prima exempla scribantur
...
id est posterior pars selle. Ecce in his exemplis aliter et aliter \parkosz{dz}

sonat. Et quamvis hec asperacio et mollicio videatur

provenire ex parte \parkosz{d} et \parkosz{z}, tamen in veritate primum \parkosz{dz} in se asperius
...
\indentK \parkosz{G} autem quamvis apud Latinos eciam duas format voces,
...
\parkosz{I} consonantem et \parkosz{g} litteram, prout secundum hanc consideracionem
...
hoc modo distinguere in diccionibus Polonicis, ut quociens \parkosz{g}
...
\newtip{67}{Ulanowski czytał: \parkosz{Jaaṇus}.}
sed \parkosz{I} consona, ut \conf{\parkosz{Iacuus}}{}¹ \parkosz{Iaaṇ} \parkosz{Iost}, quod est proprium nomen
...
% ut \PARKOSZ{ṃaꝿda} \PARKOSZ{ꝿlaſz} \PARKOSZ{ꝿnew} \PARKOSZ{ꝿrod}. Sed si ponitur cum \parkosz{e} et \parkosz{I}
