...
seu spissum et \textit{dz} molle. Exemplum primi: \parkosz{dal'} \parkosz{deeɲko} \parkosz{diɱ}

\parkosz{dooɱ} \parkosz{duɱaa} \parkosz{doøb}. Exemplum secundi: \parkosz{dzaƚ} \parkosz{dzen'} \parkosz{dziv} \parkosz{\hyphh{dzol}{da}}

\parkosz{\hyphh{dzol}{da}} \parkosz{dzuƚa} \parkosz{dzøøgiɬ} \parkosz{dzøøſƚa}. Itaque prima exempla scribantur
...
interdum mollius profertur. Exemplum primi: \parkosz{ɠviſzdz} id est sibila,

\parkosz{ɠviſd} id est nux perforata a verme. Exemplum secundi: \parkosz{Gvÿſzdz}
...
finientes. Exemplum prime vocis ut \parkosz{ɠaad} \parkosz{ɠedka} \parkosz{ɠid}

\parkosz{ɠode} \parkosz{ɠuſz} \parkosz{ɠøſſz} \parkosz{ɱayda} \parkosz{miɠdal} \parkosz{rooɠ} \parkosz{ſmuɠ}.

Exemplum secunde vocis ut \parkosz{gee} id est comedit, \parkosz{geemi} id est comedimus

cum suis condeclineis. Scribantur ergo primi exempli dicciones

per \parkosz{ɠ} cum unco retorto versus dexteram partem, sicut 

scribunt ipsum Italici, ut sic: \parkosz{ɠraad} \parkosz{ɠruuda} \parkosz{ɠroſch},

secundi autem modi seu exempli per \parkosz{g} simplex, ut est

usitatum, cum simplici unco versus sinistram partem,

ut retorto versus dexteram, ut \parkosz{gee} \parkosz{geeɱ} \parkosz{gyɱ}.
...
\parkosz{Iaronimus}, \parkosz{Iohannes}, \parkosz{Iunius}, \parkosz{genus}, \parkosz{gymnasium}. Et eodem modo Poloni
...
\newtip{67}{Ulanowski czytał: Jaanus.}
sed \textit{I} consona, ut \conf{\parkosz{Iacuus}}{}¹ \parkosz{Iaan} \parkosz{Iost}, quod est proprium nomen 
...
ut \PARKOSZ{maɠda} \PARKOSZ{ɠlaſz} \PARKOSZ{ɠnew} \PARKOSZ{ɠrod}. 
...
ut \PARKOSZ{maɠda} \PARKOSZ{ɠlaſz} \PARKOSZ{ɠnew} \PARKOSZ{ɠrod}. Sed si ponitur cum \textit{e} et \textit{I}
