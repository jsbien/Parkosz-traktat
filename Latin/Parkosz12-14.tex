...
\parkosz{h} . \parkosz{k}. \parkosz{ⱥ}. \parkosz{r}. \parkosz{t}. \parkosz{x} . \parkosz{ij} et \parkosz{z}., nisi in quantum cum
...
nisi, ut premissum est, nos in antea \parkosz{k} loco \parkosz{c} obtusi

utemur. Nam etsi prius scribebantur iste dicciones: \parkosz{kath} \parkosz{kɬoda}

\parkosz{kɲap} \parkosz{kɱotr} \parkosz{krooɬ} \parkosz{kopa} etc. per \parkosz{c}, nos deinceps

\newtip{79}{W rkp.: singulas.}
scribemus omnes istas dicciones et similes¹ per \parkosz{k} ut \parkosz{kath}
% ł? W rkp.: singulas.

\parkosz{kɬoda} \parkosz{kɲap}, \parkosz{kɱotr} \parkosz{kroɬ} \parkosz{kuṇrath} \parkosz{køøth}. Et

in veritate \parkosz{q} sicut apud Latinos, ita et apud Polonos

superfluit. Nam, ut premissum est, sicut loco \parkosz{c} obtusi

\parkosz{k} utemur, sic loco \parkosz{q} \parkosz{k} uti possemus. Exemplum sicut
...
in superiori parte ponuntur, videlicet \colorbox{olive}{\Cardo{⁊̵}}¹, \colorbox{olive}{\Cardo{ꝯ̃}}²,\colorbox{olive}{\Cardo{ſꝫ}}³, \colorbox{olive}{\Cardo{ꝯ}}⁴, \colorbox{olive}{\Cardo{t  }}⁵,  Hos
% 80	Tj. edam.
% The first one is described as "edam",[!!!] it looks to me as TIRONIAN SIGN ET
% and COMBINING SHORT STROKE OVERLAY.
% 81	Tj. contra.
...
\indentP \add{S}equitur modo abecedarium cum \hyphh{distinc}{cionibus}

\hypht{distinc}{cionibus} et exemplis caracterum et figurarum

presignatum. Hoc tamen premitto,

quod in nostro abecedario non eundem ordinem littere habent,

sicut in Latino, ex causis certis. Nam \parkosz{k} non ponetur inter

\parkosz{I}, et \parkosz{l}, sed ante \parkosz{d}, ut sit differenda insignior inter \parkosz{c} proprie vocis

et \parkosz{c} obtusum, loco cuius ut premissum \parkosz{k} ponemus.

Sic eciam \parkosz{I} ponetur ante \parkosz{h} propter connexitatem exemplorum,

et \parkosz{y} sequetur statim post \parkosz{I}, ut habeatur inter ea \hyphh{ali}{qualis}

\hypht{ali}{qualis} differencia. Et \parkosz{z} statim post \parkosz{s} propter similitudinem vocis. Tamen
