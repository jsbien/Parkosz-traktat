...
\parkosz{ġnyaaſdo}, de \textit{E}: \parkosz{nyewyaſta}, de \textit{I}: \parkosz{nĳcz}. Hec differencia 

insufficiens erat, nam inter \parkosz{Nya}, quod fuit idolum, et \parkosz{naa}, 

sillabam in diccione \parkosz{ġnyaſdo} positam, non erat differencia. Sic de 
...
denotandum \textit{i}, quo facto non erit differencia inter \conf{\parkosz{koonĳ}}{}, nominativum singularem, 

\newtip{52}{Winno być: genitivum.}
\secondtip{53}{Winno być: fuġa.}
et \parkosz{koonĳ}, accusativum¹ pluralem. Sic inter \parkosz{ġonĳ} id est fugatur² in \hyphh{im}{perativo}
...
\overstr{ġnyaſdo} \parkosz{ġnaſdo}· \parkosz{newaaſta}· \parkosz{niſczotha}, similiter de \textit{p} 
...
\overstr{ut ar} id est arma, \parkosz{czyn} id est fac, \parkosz{czop}· \parkosz{czuġe}· \conf{\parkosz{czeebu}}{}¹ \parkosz{czoſɲek}. 
