...
non erit a modo necesse circa \conf{\parkosz{ṁ}}{}¹ molle ponere duplex \textit{ĳ} et vocalem \hyphh{se}{quentem}
...
\splitlines
adeps, \parkosz{ṁeedz}· \parkosz{ṁood} id est mel, \parkosz{ṁⱥﬀjo}· \parkosz{ṁaaſġa}.
...
\parkosz{ġṅyaaſdo}, de \textit{E}: \parkosz{ṅyewyaſta}, de \textit{I}: \parkosz{ṅĳcz}. Hec differencia 
...
denotandum \textit{i}, quo facto non erit differencia inter \conf{\parkosz{kooṅĳ}}{}, nominativum singularem, 

\newtip{52}{Winno być: genitivum.}
\secondtip{53}{Winno być: fuġa.}
et \parkosz{kooṅĳ}, accusativum¹ pluralem. Sic inter \parkosz{ġoṅĳ} id est fugatur² in \hyphh{im}{perativo}
% 52 Winno być: genitivum.
% *s Winno być: fuga.

\splitlines
\hypht{im}{perativo}, et \parkosz{ġonĳ} id est fugat.
