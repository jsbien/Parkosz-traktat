...
per \textit{g}. Exemplum: \parkosz{Iacobus}, \parkosz{Iaṇua}; de \textit{o}: \parkosz{Iocus}, \parkosz{ioculator}; de \textit{u}

: \textit{ius}, \textit{iudicium}. Ubi autem \textit{I} consona iungitur \textit{e} vocali, ibi

% TO DO: do wyjaśnienia
aliquando scribunt \textit{I} consonam, aliquando \textit{g} litteram. Exemplum ut \parkosz{Ieroṇiṃus},
...
\parkosz{ſol}, \parkosz{ſal}, \parkosz{ṃiſit}, \parkosz{ṃiﬀa}. Alio modo scribitur convolute, sicut
...
in \textit{z}. Exemplum primi: \parkosz{Zavada} vel \parkosz{zijġɱuṇt} \parkosz{zophia}
