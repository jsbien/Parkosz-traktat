...
vocalibus, quamvis non profertur cum \parkosz{ɠ} retorto, non oportet in
...
per \textit{g}. Exemplum: \parkosz{Iacobus}, \parkosz{Ianua}; de \textit{o}: \parkosz{Iocus}, \parkosz{ioculator}; de \textit{u}

: \textit{ius}, \textit{iudicium}. Ubi autem \textit{I} consona iungitur \textit{e} vocali, ibi

aliquando scribunt \textit{I} consonam, aliquando \textit{g} litteram. Exemplum ut \parkosz{Ieronimus},

\parkosz{Ieremias} et hoc fere semper in propriis nominibus. In appellativis
...
\parkosz{ſol}, \parkosz{ſal}, \parkosz{miſit}, \parkosz{miſſa}. Alio modo scribitur convolute, sicut 
...
principio diccionum, vocali aut consona subsequente. Exemplum primi: \parkosz{ſaam}

\parkosz{seen} \parkosz{Syɲ} \parkosz{Sova} \parkosz{Suuɱ} \parkosz{Søød}. Exemplum secundi: \parkosz{Struſ}
...
\parkosz{Sbil}¹ \parkosz{Sɠaɠa} \parkosz{Sɱøød} \parkosz{Spøød}.
...
in \textit{z}. Exemplum primi: \parkosz{Zavada} vel \parkosz{zĳġɱunt} \parkosz{zophia}

\parkosz{Zuzanna} \parkosz{zøøb}. Exemplum secundi: \parkosz{zɱuda} \parkosz{zɓyƚ} \parkosz{zdroʋ}.
...
\overstr{ſaal}\parkosz{ſaaƚ}. Unde quamvis ibi molliter proferatur, tamen proprio 
