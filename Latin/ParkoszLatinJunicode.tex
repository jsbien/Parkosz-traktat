...
(\url{http://djvu.sourceforge.net/djview4.html}) i w programie wkleić
  ...
  licencji, modyfikacji może dokonywać każdy zainteresowany bez pytania
  o zgodę.

  Więcej informacji na ten niniejszej edycji można znaleźć m.in. w
moich  artykułach:
  \begin{itemize}
  \item Traktat Parkosza. Eksperymentalna edycja
    elektroniczna. \textit{Poznańskie Studia Polonistyczne. Seria
    Językoznawcza}, Tom 26 Nr 1 (2019), s.
    27–69. \url{https://doi.org/10.14746/pspsj.2019.26.1.2}
  \item  Parkosz’s Treatise from a Typographic Point of View 26(1),
  \textit{Scripta \& e-Scripta} Issue No: 22. 2002, p. 37-57
...
\item Representing Parkosz's alphabet in the Junicode
  font. \textit{TUGboat. The Communications of the \TeX{} Users
    Group}, Volume 43 Issue 3 (2022), pp. 247-251,
  \url{https://doi.org/10.47397/tb/43-3/tb135bien-parkosz}.
  \end{itemize}
