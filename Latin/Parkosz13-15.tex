...
\indentVerse  \textit{aa} ſſovitho ꝿdze ſſzø ʋſdƚuſzaa/
...
% znika e!!!
\indentVerse ɬudzij ʋſzyſtkĳch oçec 
...
\fullverselines
 ...
 \textit{\hypht{ſba}{voɲeġo}} Svirzcheɱ okrøꝿɬem piſſi • ɓ •/
...
· \textit{c} • ſvoĳ ꝿƚos meʋa

\indentVerse Svikƚem pĳſmeɱ  
...
\newverseline \hypht{bar}{zo} ġru6eĳe.

\indentVerse Thako piſſmem \textit{czas} \hyphh{ʋiſɲa}{ĳe}

% \includegraphics[width=\hsize]{wierszP18}

\newverseline \hypht{ʋiſɲa}{ĳe} Ġdy \add{h} przĳpiſſano bødze/
...
\indentVerse Anĳ theſzkɲoſczĳ uczĳnĳƚ
...
\indentVerse  Piſch ġee \hyphh{Vġĳ}{mo}

% \includegraphics[width=\hsize]{wierszP24}

\splitverse

\hypht{Vġĳ}{mo} boſze thako/
...
\obeylines
\indentVerse ĳeſzemczĳ ɲapiſſaƚ iako¹
...
\newtip{87}{Winno być: per se \textit{ꝿ}, improprie \textit{g}.}
ġ ꝿ¹  i ĳ ƚ ɬ
