...
\indentVerse \parkosz{uṁeĳ} \parkosz{obecado} \parkosz{ṁoĳe}/
...
\obeylines
\settowidth{\indentV}{\parkosz{itefz} \parkosz{prave}/ \parkosz{uṁeĳ} \parkosz{obecado} \parkosz{ṁoĳe}/}
...
\indentVerse \parkosz{ɬudzij} \parkosz{ʋſzyſtkĳch} \parkosz{oçec} 
...
\newversesubline \parkosz{Ṅepiſſch} 
...
\parkosz{\hypht{ġḷoſ}{ſu}} \parkosz{ṁeeç} \parkosz{ṅebødze}

\settowidth{\indentV}{\parkosz{\hypht{ġḷoſ}{ſu}} \parkosz{ṁeeç} \parkosz{ṅebødze}}
...
\settowidth{\indentV}{\parkosz{ſſzøṅdze}}
...
% brak Ƥ
\parkosz{Ƥiſſaɲ} \parkosz{bⱥdze} \parkosz{przes} \parkosz{\textit{k}} \parkosz{ĳ} \parkosz{\textit{kuur}}
...
· \parkosz{\textit{c}} · \parkosz{ſvoĳ} \parkosz{ꝿḷos} \parkosz{ṁeʋa}

\indentVerse \parkosz{Svikḷeṁ} \parkosz{pĳſṁeɱ}
...
\indentVerse \parkosz{Aɬe} \parkosz{\textit{çeløçu}} \parkosz{ĳ} \parkosz{\textit{çalu}}/
...
\splitverse
  ...
  · \parkosz{Q} · \parkosz{przĳpiſſy} \parkosz{thak} \parkosz{ġeɱv}

\indentVerse \parkosz{Ġeſtɬi} \parkosz{\textit{c}} \parkosz{\hyphh{bar}{zo}}

% \includegraphics[width=\hsize]{wierszP17}

\newverseline \parkosz{\hypht{bar}{zo}} \parkosz{ġruɓeĳe}.

\indentVerse \parkosz{Thako} \parkosz{piſſṁeṁ} \parkosz{\textit{czas}} \parkosz{\hyphh{ʋiſɲa}{ĳe}}

% \includegraphics[width=\hsize]{wierszP18}

\newverseline \parkosz{\hypht{ʋiſɲa}{ĳe}} \parkosz{Ġdy} \add{h} \parkosz{przĳpiſſaṅo} \parkosz{bødze}/
...
\indentVerse \parkosz{Aɬe} \parkosz{bich} \parkosz{çi} \parkosz{\hyphh{ṅeprze}{dḷuſziḷ}}

% \includegraphics[width=\hsize]{wierszP20}

\splitverse

\parkosz{\hypht{ṅeprze}{dḷuſziḷ}}

\indentVerse \parkosz{Aṅĳ} \parkosz{theſzkɲoſczĳ} \parkosz{uczĳṅĳḷ}

\indentVerse \parkosz{Patrzĳ} 
...
\parkosz{Boç} \parkosz{ʋṅye\conf{ɱ}{}} \parkosz{kaſzde} \parkosz{ſḷoʋko} \parkosz{thobe} /
...
\indentVerse  \parkosz{Piſch} \parkosz{ġee} \parkosz{\hyphh{Vġĳ}{ṁo}}

% \includegraphics[width=\hsize]{wierszP24}

\splitverse

\parkosz{\hypht{Vġĳ}{ṁo}} \parkosz{boſze} \parkosz{thako}/
...
\obeylines
\indentVerse \parkosz{ĳeſzeṁczĳ} \parkosz{ɲapiſſaḷ} \parkosz{iako}¹
