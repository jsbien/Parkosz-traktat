...
\catcode `\^^M=5
\newtip{85}{Tak w rkp., z pewnością należy czytać \parkosz{ktorem}, a nie \parkosz{któreż}, co jednak
...
\settowidth{\indentV}{\parkosz{Aɬe} \parkosz{ꝿdze}}
 \indentVerse · \parkosz{\textit{c}} · \parkosz{ſvoÿ} \parkosz{ꝿḷos} \parkosz{ṃeʋa}

 %\indentVerse
 \parkosz{Svikḷeṃ} \parkosz{pÿſṃeɱ}
...
\indentVerse \parkosz{\textit{caḷo}} \parkosz{tak} \parkosz{da}/
...
\parkosz{Ġdÿ} \add{h} \parkosz{przÿpiſſaṇo} \parkosz{bødze}/
...
\parkosz{Piſch} \parkosz{ġee} \parkosz{\hyphh{Vġij}{ṃø}}
...
\indentVerse \parkosz{\hypht{Vġij}{ṃø}} \parkosz{boſze} \parkosz{thako}/
...
\obeylines
\parkosz{ÿeſzeṃczÿ} \parkosz{ɲapiſſaḷ} \parkosz{iako}¹
...
\parkosz{S} in lingua Polonorum iſtas in ſe ſex differencias habet \parkosz{ſ} \parkosz{s}

\splitlines

\settowidth{\indentV}{\parkosz{S} in lingua Polonorum iſtas in ſe ſex differencias habet \parkosz{ſ} \parkosz{s}}
\indentVerse \parkosz{ſſz} \parkosz{ſch} \parkosz{ſz} \parkosz{zz}
