...
\parkosz{czĳaſɲo}, \parkosz{czĳjeṁø} \parkosz{czĳjelø} \parkosz{czĳolek} \parkosz{czĳvlaa} \parkosz{czĳąġne},
...
de \textit{I}: \parkosz{czĳṁ}, \parkosz{czĳɲ}, quod est prime asperacionis exemplum. Quomodo
...
\overstr{c} \parkosz{çeṁø} \parkosz{çoḷek} \parkosz{çuḷa} \parkosz{çøġne}. Et hoc modo inter \parkosz{czyṁ}
...
\textit{k}. Exemplum primi ut \parkosz{kath} \parkosz{kaṁeen} \parkosz{koth} \parkosz{kooth} \parkosz{kuurcz}
