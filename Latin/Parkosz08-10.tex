...
\parkosz{czijaſɲo}, \parkosz{czijjeṁø} \parkosz{czijjeḷø} \parkosz{czijoḷek} \parkosz{czijvḷaa} \parkosz{czijⱥġṇe},
...
\overstr{c} \parkosz{çeṁø} \parkosz{çoḷek} \parkosz{çuḷa} \parkosz{çøġṇe}. Et hoc modo inter \parkosz{czyṁ}
...
\parkosz{cap} \parkosz{ceɓuɬa} \parkosz{ciſz} id est caix, de \textit{o}: \parkosz{co} id est quid, \parkosz{cuudṇi}
...
\textit{k}. Exemplum primi ut \parkosz{kath} \parkosz{kaṁeeṇ} \parkosz{koth} \parkosz{kooth} \parkosz{kuurcz}
