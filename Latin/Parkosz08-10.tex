...
\parkosz{czĳaſɲo}, \parkosz{czĳjeṁø} \parkosz{czĳjeḷø} \parkosz{czĳoḷek} \parkosz{czĳvḷaa} \parkosz{czĳąġṅe},
...
illis diccionibus: \parkosz{bozaczĳṅ} \parkosz{prødoczĳṅ} \parkosz{Coczĳṅ} vel de similibus ?

Nescio enim, quomodo dicciones in scripto different \parkosz{czyɱ} prime \hyphh{aspe}{racionis}

\hypht{aspe}{racionis}, id est cum quo, et \parkosz{czĳṅ} secunde asperacionis, que est sillaba de

predictis diccionibus sicut \parkosz{bozączĳṅ} etc. Item \parkosz{czĳrpaal} id est hausit et
