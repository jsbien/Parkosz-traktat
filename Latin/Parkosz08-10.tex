...
\overstr{c} \parkosz{çemø} \parkosz{çoḷek} \parkosz{çuḷa} \parkosz{çøġne}. Et hoc modo inter \parkosz{czym}

et \parkosz{czyɲ} prime asperacionis et \parkosz{chçeeĳ} id est velis, \parkosz{çĳrpaal}

\parkosz{ſçĳrpaaḷ} et \parkosz{çypaaḷ} notabilis esset differencia. In molliter
