...
autem asperatis scribatur simplex \parkosz{c} sine omni asperacione, 

ut \parkosz{cap} \parkosz{ceɓuɬa} \parkosz{ciſz} id est caix, de \parkosz{o}: \parkosz{co} id est quid, \parkosz{cuudṇi}
