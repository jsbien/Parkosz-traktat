...
\parkosz{czÿaſɲo}, \parkosz{czÿjemø} \parkosz{czÿjelø} \parkosz{czÿolek} \parkosz{czÿvlaa} \parkosz{czÿągne},
...
de \textit{I}: \parkosz{czÿm}, \parkosz{czÿɲ}, quod est prime asperacionis exemplum. Quomodo

autem scriberemus \parkosz{czyn} cum 2-a asperacione, quod significat sillabam de

illis diccionibus: \parkosz{bozaczÿn} \parkosz{prødoczÿn} \parkosz{Coczÿn} vel de similibus ?

Nescio enim, quomodo dicciones in scripto different \parkosz{czyɱ} prime \hyphh{aspe}{racionis}

\hypht{aspe}{racionis}, id est cum quo, et \parkosz{czÿn} secunde asperacionis, que est sillaba de

predictis diccionibus sicut \parkosz{bozączÿn} etc. Item \parkosz{czÿrpaal} id est hausit et

\parkosz{czÿrpal} id est passus est, saltem circa primam sillabam, de qua est sermo.

Different enim ista circa \textit{p} spissum et molle. Sic eciam \parkosz{ſczÿrpaal}
...
\conf{duplicis}{}¹ \textit{ÿ} scribemus simplex \textit{c} cum uno tractu in parte
% <3 'w rkp_. duplex.

inferiore, quod antiqui loco \textit{z} ponebant, ut apparet

in antiquis libris, ut sic: ç ç, et hac littera uteremur
...
et \parkosz{czyɲ} prime asperacionis et \parkosz{chçeeÿ} id est velis, \parkosz{çÿrpaal}

\parkosz{ſçÿrpaaƚ} et \parkosz{çypaaƚ} notabilis esset differencia. In molliter
