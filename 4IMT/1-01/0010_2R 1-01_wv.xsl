...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">0010_2R 1-01</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">100</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1544</xsl:variable>
    <xsl:variable name="ZoomImageHeight">193</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.518135</xsl:variable>
    <xsl:variable name="ScaledImageFileName">0010_2R 1-01_wv_0010_2R 1-1.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">0010_2R 1-01_wv_zoom_0010_2R 1-1.jpg</xsl:variable>
