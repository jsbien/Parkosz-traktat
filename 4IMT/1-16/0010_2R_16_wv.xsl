...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">0010_2R_16</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">46</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1632</xsl:variable>
    <xsl:variable name="ZoomImageHeight">94</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.490196</xsl:variable>
    <xsl:variable name="ScaledImageFileName">0010_2R_16_wv_0010_2R_16.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">0010_2R_16_wv_zoom_0010_2R_16.jpg</xsl:variable>
