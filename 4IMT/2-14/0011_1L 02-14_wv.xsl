...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">0011_1L 02-14</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">44</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3492</xsl:variable>
    <xsl:variable name="ZoomImageHeight">193</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.229095</xsl:variable>
    <xsl:variable name="ScaledImageFileName">0011_1L 02-14_wv_0011_1L 02-14.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">0011_1L 02-14_wv_zoom_0011_1L 02-14.jpg</xsl:variable>
