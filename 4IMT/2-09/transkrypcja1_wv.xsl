...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">transkrypcja1</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">32</xsl:variable>
    <xsl:variable name="ZoomImageWidth">2163</xsl:variable>
    <xsl:variable name="ZoomImageHeight">87</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.369857</xsl:variable>
    <xsl:variable name="ScaledImageFileName">transkrypcja1_wv_transkrypcjazoom.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">transkrypcja1_wv_zoom_transkrypcjazoom.jpg</xsl:variable>
