...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">1-10</xsl:variable>
    ...
    <xsl:variable name="ScaledImageFileName">1-10_wv_1-10.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-10_wv_zoom_1-10.jpg</xsl:variable>
