...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">[IMPORTANT: title of the document]</xsl:variable>
    <xsl:variable name="DocFileName">1-10.2</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">25</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1000</xsl:variable>
    <xsl:variable name="ZoomImageHeight">31</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.8</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-10.2_wv_1-10.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-10.2_wv_zoom_1-10.jpg</xsl:variable>
