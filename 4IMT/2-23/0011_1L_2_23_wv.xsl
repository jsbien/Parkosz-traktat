...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">0011_1L_2_23</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">50</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1744</xsl:variable>
    <xsl:variable name="ZoomImageHeight">108</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.458716</xsl:variable>
    <xsl:variable name="ScaledImageFileName">0011_1L_2_23_wv_0011_1L_2_23.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">0011_1L_2_23_wv_zoom_0011_1L_2_23.jpg</xsl:variable>
