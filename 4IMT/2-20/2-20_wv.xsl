...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2-20</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">44</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3532</xsl:variable>
    <xsl:variable name="ZoomImageHeight">196</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.226501</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-20_wv_2-20.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-20_wv_zoom_2-20.jpg</xsl:variable>
