...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">0-14</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">86</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3353</xsl:variable>
    <xsl:variable name="ZoomImageHeight">360</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.238592</xsl:variable>
    <xsl:variable name="ScaledImageFileName">0-14_wv_00-14_wv_zoom_1-14.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">0-14_wv_zoom_00-14_wv_zoom_1-14.jpg</xsl:variable>
