...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">1-46,47,48</xsl:variable>
    <xsl:variable name="DocFileName">46-48</xsl:variable>
    <xsl:variable name="ScaledImageWidth">799</xsl:variable>
    <xsl:variable name="ScaledImageHeight">96</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3336</xsl:variable>
    <xsl:variable name="ZoomImageHeight">400</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.239508</xsl:variable>
    <xsl:variable name="ScaledImageFileName">46-48_wv_0010_2Rob.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">46-48_wv_zoom_0010_2Rob.jpg</xsl:variable>
