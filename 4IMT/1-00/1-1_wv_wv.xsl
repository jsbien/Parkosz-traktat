...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">1-1_wv</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">95</xsl:variable>
    <xsl:variable name="ZoomImageWidth">4868</xsl:variable>
    <xsl:variable name="ZoomImageHeight">581</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.164339</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-1_wv_wv_0010_2R-1.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-1_wv_wv_zoom_0010_2R-1.jpg</xsl:variable>
