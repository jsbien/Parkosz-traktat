...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2-06</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">49</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3580</xsl:variable>
    <xsl:variable name="ZoomImageHeight">220</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.223464</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-06_wv_OGUN.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-06_wv_zoom_OGUN.jpg</xsl:variable>
