...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">09</xsl:variable>
    <xsl:variable name="DocFileName">1-09</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">32</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3489</xsl:variable>
    <xsl:variable name="ZoomImageHeight">141</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.229292</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-09_wv_1-09.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-09_wv_zoom_1-09.jpg</xsl:variable>
