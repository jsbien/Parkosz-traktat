...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2-21</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">56</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3516</xsl:variable>
    <xsl:variable name="ZoomImageHeight">244</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.227531</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-21_wv_2-21.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-21_wv_zoom_2-21.jpg</xsl:variable>
