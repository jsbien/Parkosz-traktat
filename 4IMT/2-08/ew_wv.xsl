...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">ew</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">45</xsl:variable>
    <xsl:variable name="ZoomImageWidth">800</xsl:variable>
    <xsl:variable name="ZoomImageHeight">45</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">ew_wv_test_wv_transkrypcjaEmilia_wv_13223575_984342838301015_1965425077_o.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">ew_wv_zoom_test_wv_transkrypcjaEmilia_wv_13223575_984342838301015_1965425077_o.jpg</xsl:variable>
