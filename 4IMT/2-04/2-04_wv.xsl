...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2-04</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">52</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1224</xsl:variable>
    <xsl:variable name="ZoomImageHeight">79</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.653595</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-04_wv_0011_1L-2-04.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-04_wv_zoom_0011_1L-2-04.jpg</xsl:variable>
