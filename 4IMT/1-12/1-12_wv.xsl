...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">1-12</xsl:variable>
    <xsl:variable name="DocFileName">1-12</xsl:variable>
    <xsl:variable name="ScaledImageWidth">799</xsl:variable>
    <xsl:variable name="ScaledImageHeight">38</xsl:variable>
    <xsl:variable name="ZoomImageWidth">800</xsl:variable>
    <xsl:variable name="ZoomImageHeight">38</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.99875</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-12_wv_asdf_wv_test1b_wv_TEST3_wv_zoom_1-12.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-12_wv_zoom_asdf_wv_test1b_wv_TEST3_wv_zoom_1-12.jpg</xsl:variable>
