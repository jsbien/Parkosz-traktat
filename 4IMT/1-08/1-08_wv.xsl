...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">1-08</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">39</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3553</xsl:variable>
    <xsl:variable name="ZoomImageHeight">175</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.225162</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-08_wv_1-08.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-08_wv_zoom_1-08.jpg</xsl:variable>
