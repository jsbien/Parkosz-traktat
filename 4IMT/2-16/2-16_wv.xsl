...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2-16</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">58</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3524</xsl:variable>
    <xsl:variable name="ZoomImageHeight">254</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.227015</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-16_wv_2-16.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-16_wv_zoom_2-16.jpg</xsl:variable>
