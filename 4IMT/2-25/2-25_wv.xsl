...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">2-25.jpg</xsl:variable>
    <xsl:variable name="DocFileName">2-25</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">41</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3336</xsl:variable>
    <xsl:variable name="ZoomImageHeight">170</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.239808</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-25_wv_2-25.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-25_wv_zoom_2-25.jpg</xsl:variable>
