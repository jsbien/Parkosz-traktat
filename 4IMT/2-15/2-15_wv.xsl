...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2-15</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">41</xsl:variable>
    <xsl:variable name="ZoomImageWidth">4772</xsl:variable>
    <xsl:variable name="ZoomImageHeight">244</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.167645</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-15_wv_2-15_wv_zoom_0011_1L-2.15.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-15_wv_zoom_2-15_wv_zoom_0011_1L-2.15.jpg</xsl:variable>
