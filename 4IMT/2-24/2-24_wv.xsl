...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">2-24.jpg</xsl:variable>
    <xsl:variable name="DocFileName">2-24</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">49</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3407</xsl:variable>
    <xsl:variable name="ZoomImageHeight">209</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.234811</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-24_wv_2-24.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-24_wv_zoom_2-24.jpg</xsl:variable>
