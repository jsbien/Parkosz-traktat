...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Praca</xsl:variable>
    <xsl:variable name="DocFileName">Praca</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">44</xsl:variable>
    <xsl:variable name="ZoomImageWidth">2048</xsl:variable>
    <xsl:variable name="ZoomImageHeight">112</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.390625</xsl:variable>
    <xsl:variable name="ScaledImageFileName">Praca_wv_praca.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">Praca_wv_zoom_praca.jpg</xsl:variable>
