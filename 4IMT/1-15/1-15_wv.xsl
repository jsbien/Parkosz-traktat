...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">1-15</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">40</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3298</xsl:variable>
    <xsl:variable name="ZoomImageHeight">163</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.242571</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-15_wv_1-15_wv_zoom_1-15.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-15_wv_zoom_1-15_wv_zoom_1-15.jpg</xsl:variable>
