...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">1-07</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">38</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3309</xsl:variable>
    <xsl:variable name="ZoomImageHeight">159</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.241765</xsl:variable>
    <xsl:variable name="ScaledImageFileName">1-07_wv_1-07.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">1-07_wv_zoom_1-07.jpg</xsl:variable>
