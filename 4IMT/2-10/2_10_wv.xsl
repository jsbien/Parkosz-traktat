...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">2_10</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">32</xsl:variable>
    <xsl:variable name="ZoomImageWidth">5025</xsl:variable>
    <xsl:variable name="ZoomImageHeight">201</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.159204</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2_10_wv_2_10.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2_10_wv_zoom_2_10.jpg</xsl:variable>
