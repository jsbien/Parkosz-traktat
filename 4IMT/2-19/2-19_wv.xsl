...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">2-19.png</xsl:variable>
    <xsl:variable name="DocFileName">2-19</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">42</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3612</xsl:variable>
    <xsl:variable name="ZoomImageHeight">188</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.221484</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-19_wv_2-19.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-19_wv_zoom_2-19.jpg</xsl:variable>
