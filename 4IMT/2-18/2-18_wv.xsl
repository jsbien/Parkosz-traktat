...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">2-18.png</xsl:variable>
    <xsl:variable name="DocFileName">2-18</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">45</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3512</xsl:variable>
    <xsl:variable name="ZoomImageHeight">196</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.22779</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-18_wv_2-18.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-18_wv_zoom_2-18.jpg</xsl:variable>
