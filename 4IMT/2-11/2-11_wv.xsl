...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">0011_1L.jpg</xsl:variable>
    <xsl:variable name="DocFileName">2-11</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">58</xsl:variable>
    <xsl:variable name="ZoomImageWidth">3597</xsl:variable>
    <xsl:variable name="ZoomImageHeight">262</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.222408</xsl:variable>
    <xsl:variable name="ScaledImageFileName">2-11_wv_0011_1L.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">2-11_wv_zoom_0011_1L.jpg</xsl:variable>
