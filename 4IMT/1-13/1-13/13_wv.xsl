...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">13</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">39</xsl:variable>
    <xsl:variable name="ZoomImageWidth">800</xsl:variable>
    <xsl:variable name="ZoomImageHeight">39</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">13_wv_0-13_wv_0-13.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">13_wv_zoom_0-13_wv_0-13.jpg</xsl:variable>
