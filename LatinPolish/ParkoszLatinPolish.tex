...
\def\secondtip#1#2{\footnotetext[\textcolor{magenta}{#1}]{#2}\def²{\annotatehere[#1]{#2}}}
\def\thirdtip#1#2{\footnotetext[\textcolor{magenta}{#1}]{#2}\def³{\annotatehere[#1]{#2}}}
\def\fourthtip#1#2{\footnotetext[\textcolor{magenta}{#1}]{#2}\def⁴{\annotatehere[#1]{#2}}}
\def\fifthtip#1#2{\footnotetext[\textcolor{magenta}{#1}]{#2}\def⁵{\annotatehere[#1]{#2}}}
