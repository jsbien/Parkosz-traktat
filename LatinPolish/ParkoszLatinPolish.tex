...
\newcommand{\polski}[1]{\colorbox{lime}{\textit{#1}}}
...
% TO DO
\let\splitpreviouslines\fullpreviouslines
...
\def\secondtip#1#2{\footnotetext[#1]{\textcolor{magenta}{#2}}\def²{\annotatehere[#1]{#2}}}
\def\thirdtip#1#2{\footnotetext[#1]{\textcolor{magenta}{#2}}\def³{\annotatehere[#1]{#2}}}
\def\fourthtip#1#2{\footnotetext[#1]{\textcolor{magenta}{#2}}\def⁴{\annotatehere[#1]{#2}}}
\def\fifthtip#1#2{\footnotetext[#1]{\textcolor{magenta}{#2}}\def⁵{\annotatehere[#1]{#2}}}
...
\end{document}
 ...
 W przeciwnym razie między \textit{męką} a
